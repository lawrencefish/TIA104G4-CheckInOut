...
public class OrderDTO {
	    ...
	    public OrderDTO(Integer memberId, Integer orderId, Date createTime, byte status, Date checkInDate,
	                    ...
	                    Integer rating, String commentContent, String commentReply, Date commentCreateTime, Integer hotelId,
	                    String hotelName, String city, String district, String address, String phoneNumber, String email, String creditcardNum) {
	        ...
	        this.orderDetails = new ArrayList<>(); // 初始化
	    }
